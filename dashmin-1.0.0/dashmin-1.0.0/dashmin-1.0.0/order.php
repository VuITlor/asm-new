...
$customers = $dbHelper->select(" SELECT * FROM orders WHERE user_id = '$user[id]' ");
?>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="order.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Đơn hàng</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="py-5 text-center">
                ...
                <a href="index_user.php" class="btn btn-primary">Back to Index</a>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <tbody>
                                <?php foreach ($customers as $customer) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="order_detail_user.php" method="post">
                                                <input type="hidden" name="id" value="<?php echo $customer['order_id']; ?>">
