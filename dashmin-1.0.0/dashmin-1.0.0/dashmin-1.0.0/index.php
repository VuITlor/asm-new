        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Oder</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="list_order.php" class="dropdown-item">List Order</a>
                            <a href="order_details.php" class="dropdown-item">Order Details</a>
                        </div>
                    </div>
                </div>
            </nav>
