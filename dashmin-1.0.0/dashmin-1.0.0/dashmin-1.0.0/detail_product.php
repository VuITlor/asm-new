        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index_user.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Chi tiết sản phẩm</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php if ($product['image']) : ?>
                            <img src="<?php echo htmlspecialchars($product['image']); ?>" class="product-image h-100" alt="<?php echo htmlspecialchars($product['name']); ?>">
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6">
                        ...
                        <a href="index_user.php" class="btn btn-secondary mt-3">Back to Products</a>
                    </div>
                </div>
            </div>
        </div>
